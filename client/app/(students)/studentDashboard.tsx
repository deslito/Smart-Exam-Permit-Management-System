...
import RoleBasedLoader from "@/components/RoleBasedLoader";
...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    Font.loadAsync(Ionicons.font).then(() => setFontLoaded(true));
  }, []);
  ...
  // Only show loader if any of the following are not ready
  const isPageLoading = loading || !fontLoaded || !imageLoaded;

  return (
    <View style={{ flex: 1 }}>
      {isPageLoading && <RoleBasedLoader role="student" />}
      <Image
